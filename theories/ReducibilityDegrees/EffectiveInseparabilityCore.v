(* The unbundled notion of effective inseparability (Kuznetsov's
   ...
   (EffectiveInseparabilityTransport.v) restated without the
   enumerable-A' plumbing -- a genuinely different (weaker-hypothesis)
   lemma, not a duplicate, since eff_insep_core itself asks for less
   than eff_insep_shape does. Parametrized over an arbitrary numbering W
   and sets A/B/A' -- not tied to any specific model or project. *)
